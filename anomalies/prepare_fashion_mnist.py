...
from picture_loading import load_and_preprocess_image

DEFAULT_NPZ_PATH = Path("data/fmnist_partitions.npz")
...
def compute_partitions(data_root: str | Path = "./data", seed: int = 42) -> tuple[dict[str, np.ndarray], np.ndarray]:
    """
